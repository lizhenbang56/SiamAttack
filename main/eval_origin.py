...
def main():
    if parsed_args.dataset_name == 'GOT-10k_Val':
        experiment = ExperimentGOT10k('/home/etvuz/projects/adversarial_attack/video_analyst/datasets/GOT-10k', subset='val',
                                      result_dir=result_dir, report_dir=report_dir, fgt_dir='')
...
if __name__ == '__main__':
    ...
    """定义文件夹"""
    result_dir = '/home/etvuz/projects/adversarial_attack/video_analyst/snapshots_agent_GT/64/result/{}/siamfcpp_googlenet/{}'.format(parsed_args.dataset_name, parsed_args.loop_num)
    report_dir = '/home/etvuz/projects/adversarial_attack/video_analyst/snapshots_agent_GT/64/report/{}/siamfcpp_googlenet/{}'.format(parsed_args.dataset_name, parsed_args.loop_num)
    """定义文件夹"""
