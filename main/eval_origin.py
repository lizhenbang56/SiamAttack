...
if __name__ == '__main__':
    ...
    """定义文件夹"""
    result_dir = os.path.join(sys.path[0], 'snapshots_imperceptible_patch/FFT/result/{}/siamfcpp_googlenet/{}'.format(parsed_args.dataset_name, parsed_args.loop_num))
    report_dir = os.path.join(sys.path[0], 'snapshots_imperceptible_patch/FFT/report/{}/siamfcpp_googlenet/{}'.format(parsed_args.dataset_name, parsed_args.loop_num))
    """定义文件夹"""
